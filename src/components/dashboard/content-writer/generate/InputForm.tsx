...
import { saveContent } from '@/app/dashboard/(apps)/content-writer/actions';
...
const InputForm = ({ generatedData }: Props) => {
  ...
  const handleGeneration = async () => {
    ...
    // Makes an api call to /api/content-writer/generate and receives a stream response
    const res = await fetch('/api/content-writer/generate', {
      method: 'POST',
