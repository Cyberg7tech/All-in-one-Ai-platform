...
import { Bell, Settings, User, LogOut, UserCog, CreditCard, Shield, Menu } from 'lucide-react';
  ...
  const notifications = [
    {
      ...
      message: 'GPT-4.1 is now available for testing',
      time: '2 hours ago',
      unread: true,
    },
    {
      ...
      message: 'Your marketing assistant agent is ready',
      time: '1 day ago',
      unread: true,
    },
    {
      ...
      <div className='flex items-center space-x-4 relative'>
        ...
        <div className='relative' ref={notificationsRef}>
          <Button
            ...
            {unreadCount > 0 && (
              <Badge
                variant='destructive'
                className='absolute -top-1 -right-1 size-5 text-xs flex items-center justify-center p-0'>
                {unreadCount}
              </Badge>
            )}
          </Button>
                ...
                {notifications.map((notification) => (
                  <div
                    ...
                    <div className='flex items-start justify-between'>
                      ...
                      {notification.unread && <div className='size-2 bg-primary rounded-full mt-1'></div>}
                    </div>
                  </div>
                ))}
              </CardContent>
        ...
        <div className='relative' ref={profileRef}>
          <div
            ...
            <div className='size-8 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center'>
            ...
            <Card className='absolute top-12 right-0 w-72 z-[9999] shadow-lg'>
              ...
              <CardContent className='space-y-4'>
                ...
                <div className='flex items-center space-x-3 p-3 bg-muted/50 rounded-lg'>
                  <div className='size-12 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center'>
