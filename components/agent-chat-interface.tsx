                      ...
                      <div className="mt-3 pt-3 border-t border-border/20">
                        ...
                        {message.toolsUsed && message.toolsUsed.length > 0 && (
                          <div className="flex items-center space-x-2 mb-2">
                            ...
                            {message.toolsUsed.map((tool) => {
                              const Icon = TOOL_ICONS[tool as keyof typeof TOOL_ICONS] || Bot
                              return (
                                <div key={tool} className="flex items-center space-x-1 px-2 py-1 bg-background/50 rounded text-xs">
                                  <Icon className="w-3 h-3" />
                                  <span>{tool.replace('_', ' ')}</span>
                                </div>
                              )
                        ...
                        <div className="flex items-center justify-between text-xs text-muted-foreground">
                          <div className="flex items-center space-x-3">
                            ...
                            {message.usage?.tokensUsed && (
                              <span>{message.usage.tokensUsed} tokens</span>
                            )}
                            {message.usage?.cost && (
