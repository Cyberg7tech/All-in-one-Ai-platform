...
export const seoConfigs = {
  home: {
    title: 'One AI - Complete AI Platform for Business',
    description:
      'Transform your workflow with 18+ AI tools, intelligent agents, advanced analytics, and seamless access to multiple AI models.',
    structuredData: {
  ...
  pricing: {
    ...
    description:
      'Simple, transparent pricing for One AI platform. Start free, upgrade as you grow. Choose the perfect plan for your business needs.',
    structuredData: {
      '@context': 'https://schema.org',
      '@type': 'Product',
  ...
  dashboard: {
    ...
    description:
      'Access your AI tools, manage agents, view analytics and control your One AI platform from the central dashboard.',
    noIndex: true,
  },
  ...
  blog: {
    ...
    description:
      'Learn about AI, automation, and business transformation with insights, tutorials, and updates from the One AI team.',
