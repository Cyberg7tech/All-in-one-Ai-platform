...
import { Search, Filter, Star, Zap, Image, Music, Video, FileText, Code, BarChart3, MessageSquare, Mic, Camera, Palette, Globe, Mail, Sparkles, TrendingUp, Bot, Brain } from 'lucide-react'
...
const AI_TOOLS: AITool[] = [
  ...
  // Business Intelligence & Analytics
  {
    ...
    href: '/dashboard/tools/forecasting',
    icon: TrendingUp,
  ...
  // Document Processing
  {
    ...
    href: '/dashboard/tools/documents',
    icon: FileText,
    category: 'Text & Content',
    featured: true,
    premium: false,
  ...
  // Automation & Workflows
  {
    ...
    href: '/dashboard/tools/workflows',
    icon: Zap,
  ...
  // Development Tools
  {
    ...
    href: '/dashboard/tools/playground',
    icon: Brain,
    category: 'Development',
    featured: true,
    premium: false,
  ...
  },
  {
    ...
    href: '/dashboard/tools/code-assistant',
    icon: Code,
    category: 'Development',
    featured: false,
    premium: false,
  ...
  // Communication & Design
  {
    ...
    href: '/dashboard/tools/voice-assistant',
    icon: Mic,
    category: 'Audio & Voice',
    featured: false,
    premium: true,
  ...
  },
  {
    ...
    href: '/dashboard/tools/design-assistant',
    icon: Palette,
    category: 'Design',
    featured: false,
    premium: false,
  ...
  },
  {
    ...
    href: '/dashboard/tools/email-assistant',
    icon: Mail,
  ...
  // Advanced Features
  {
    ...
    href: '/dashboard/tools/web-scraper',
    icon: Globe,
    category: 'Business Intelligence',
    featured: false,
    premium: true,
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {featuredTools.map((tool) => (
            <Card key={tool.id} className="group hover:shadow-lg transition-all hover:scale-[1.02] cursor-pointer relative">
          ...
          {CATEGORIES.map((category) => (
            ...
            >
              {category !== 'All' && CATEGORY_ICONS[category as keyof typeof CATEGORY_ICONS] && (
                React.createElement(CATEGORY_ICONS[category as keyof typeof CATEGORY_ICONS], { className: "w-4 h-4 mr-2" })
              )}
              {category}
            </Button>
          ))}
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      <CardTitle className="text-base leading-tight">{tool.name}</CardTitle>
                      {tool.premium && (
                        <Badge variant="outline" className="mt-1 text-xs">Premium</Badge>
                      )}
                      {tool.comingSoon && (
                        <Badge variant="outline" className="mt-1 text-xs">Coming Soon</Badge>
                      )}
