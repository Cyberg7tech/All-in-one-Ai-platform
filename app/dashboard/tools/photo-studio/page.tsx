...
export default function PhotoStudioPage() {
  ...
  const enhancements = [
    {
      value: 'auto-enhance',
      label: 'Auto Enhance',
      description: 'Automatic intelligent enhancement',
      icon: '✨',
    },
    ...
    { value: 'vintage', label: 'Vintage Effect', description: 'Classic film-like appearance', icon: '📸' },
    {
      value: 'black-white',
      label: 'Black & White',
      description: 'Artistic monochrome conversion',
      icon: '⚫',
    },
  ...
  const handleEnhance = async () => {
    ...
    try {
      ...
      setPhotoEdits((prev) =>
        prev.map((edit) => (edit.id === newEdit.id ? { ...edit, status: 'failed' } : edit))
      );
    } finally {
        ...
        <div className='lg:col-span-2 space-y-6'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Upload a photo to start editing and enhancing</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          {uploadedImage && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>Choose how you want to enhance your photo</CardDescription>
              </CardHeader>
      ...
      {photoEdits.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Your enhanced photos and editing history</CardDescription>
          </CardHeader>
          <CardContent>
                    ...
                    <div className='space-y-3'>
                      ...
                      <div className='text-xs space-y-1'>
                        <p>
                          ...
                          {enhancements.find((e) => e.value === edit.enhancement)?.label}
                        </p>
                        <p>
                          <strong>Adjustments:</strong> B:{edit.settings.brightness}% C:
                          {edit.settings.contrast}% S:{edit.settings.saturation}%
                        </p>
                      </div>
