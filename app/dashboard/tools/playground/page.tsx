    ...
    responses: [
      {
        ...
        model: 'gpt-4',
        content:
          'Quantum computing is like having a super-powered computer that can explore many possibilities at once...',
        tokens: 150,
        cost: 0.0045,
        responseTime: 2.3,
            ...
            <Card>
              ...
              <CardContent className='space-y-4'>
                ...
                <div>
                  ...
                  />
                  <p className='text-xs text-muted-foreground mt-1'>Set the AI's behavior and context</p>
                </div>
              </CardContent>
            </Card>
                  ...
                  {result.responses.map((response) => {
                    ...
                    return (
                      <div key={response.id} className='p-3 border rounded'>
                        ...
                        <p className='text-xs text-muted-foreground line-clamp-3 mb-2'>{response.content}</p>
