...
const AI_MODELS = [
  ...
  { id: 'stable-diffusion', name: 'Stable Diffusion XL', description: 'Great for realistic images', cost: '$$' },
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex items-center mb-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Create stunning images with AI using DALL-E 3 and Stable Diffusion</p>
        </div>
      </div>
