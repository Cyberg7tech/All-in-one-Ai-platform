...
export default function TextToSpeechPage() {
  ...
  const voices: Voice[] = [
    { id: 'professional-female', name: 'Sarah Professional', gender: 'female', accent: 'American', style: 'Business' },
    { id: 'professional-male', name: 'David Professional', gender: 'male', accent: 'American', style: 'Business' },
    ...
    { id: 'narrator-male', name: 'Morgan Narrator', gender: 'male', accent: 'American', style: 'Documentary' },
    { id: 'energetic-female', name: 'Lisa Energetic', gender: 'female', accent: 'Australian', style: 'Upbeat' },
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <div className="flex justify-between text-xs text-muted-foreground mt-1">
                  ...
                  <span>
                    {text.trim().split(' ').filter(w => w).length} words • ~{estimatedDuration}s
                  </span>
                </div>
              </div>
      ...
      {generatedAudios.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Your converted text-to-speech audio files
            </CardDescription>
          </CardHeader>
          <CardContent>
