...
import { ArrowLeft, Upload, FileText, Download, Eye, Trash2, Search, Filter, Bot, Brain, Languages, MessageSquare, BarChart3 } from 'lucide-react'
...
const SAMPLE_DOCUMENTS: ProcessedDocument[] = [
  {
    ...
    summary: 'This quarterly financial report shows strong growth in revenue and profitability, with key highlights including 15% increase in sales and improved operational efficiency.',
  ...
  },
  {
    ...
    summary: 'Comprehensive product requirements document outlining features, user stories, and technical specifications for the new One Ai platform launch.',
...
export default function DocumentProcessingPage() {
  ...
  const simulateDocumentProcessing = async (doc: ProcessedDocument, file: File): Promise<ProcessedDocument> => {
          ...
          <div className="lg:col-span-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Upload multiple documents for AI-powered analysis
                </CardDescription>
              </CardHeader>
          ...
          <div className="lg:col-span-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Uploaded {selectedDocument.uploadDate.toLocaleString()} • {formatFileSize(selectedDocument.size)}
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="flex justify-between text-sm">
                  ...
                  <Badge className={
                    selectedDocument.status === 'completed' ? 'bg-green-100 text-green-700' :
                    selectedDocument.status === 'processing' ? 'bg-yellow-100 text-yellow-700' :
                    'bg-red-100 text-red-700'
                  }>
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <Badge variant={
                    selectedDocument.sentiment === 'positive' ? 'default' :
                    selectedDocument.sentiment === 'negative' ? 'destructive' : 'secondary'
                  }>
