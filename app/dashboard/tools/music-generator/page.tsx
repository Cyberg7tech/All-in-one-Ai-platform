    ...
    try {
      ...
      if (data.success) {
        setGeneratedMusic((prev) =>
          prev.map((music) =>
            music.id === newMusic.id ? { ...music, audioUrl: data.audioUrl, status: 'completed' } : music
          )
        );
      } else {
      ...
      setGeneratedMusic((prev) =>
        prev.map((music) => (music.id === newMusic.id ? { ...music, status: 'failed' } : music))
      );
    } finally {
        ...
        <div className='lg:col-span-2 space-y-6'>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Customize the style and characteristics of your music</CardDescription>
            </CardHeader>
                ...
                <div className='grid grid-cols-2 md:grid-cols-3 gap-3 mt-2'>
                  {genres.slice(0, 6).map((genreOption) => (
                    <div
                      ...
                      <div className='text-xs text-muted-foreground'>{genreOption.description}</div>
                    </div>
                  ))}
                </div>
      ...
      {generatedMusic.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Your AI-generated music compositions</CardDescription>
          </CardHeader>
          <CardContent>
