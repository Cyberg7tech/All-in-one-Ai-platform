...
import { ArrowLeft, Upload, Download, Play, TrendingUp, AlertTriangle, BarChart3, LineChart, Calendar, FileText, Settings } from 'lucide-react'
...
export default function ForecastingPage() {
  ...
  const downloadResults = () => {
    ...
    const csvContent = [
      ...
      ...currentResult.data.map(d => 
        `${d.date},${d.value || ''},${d.predicted || ''},${d.anomaly || false},${d.confidence || ''}`
      )
    ].join('\n')
            ...
            return (
              <div key={index} className="flex flex-col items-center flex-1 min-w-0">
                <div className="flex flex-col justify-end h-full space-y-1">
                  ...
                  {point.value > 0 && (
                    <div 
                      className={`rounded-t-sm min-h-1 ${
                        point.anomaly ? 'bg-red-500' : 'bg-primary'
                      }`}
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex items-center mb-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Predict future trends and detect anomalies in your time series data</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Upload CSV or JSON files with date and value columns
              </CardDescription>
            </CardHeader>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {uploadedData.length} data points loaded
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  {FORECAST_MODELS.map((model) => (
                    <div
                      ...
                      className={`p-4 border rounded-lg cursor-pointer transition-colors ${
                        selectedModel === model.id ? 'border-primary bg-primary/5' : 'border-border hover:bg-muted/50'
                      }`}
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="flex space-x-2">
                          <Badge variant="outline" className="text-xs">{model.complexity}</Badge>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {ANOMALY_METHODS.map((method) => (
                    <div
                      key={method.id}
                      className={`p-4 border rounded-lg cursor-pointer transition-colors ${
                        selectedAnomalyMethod === method.id ? 'border-primary bg-primary/5' : 'border-border hover:bg-muted/50'
                      }`}
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">
                Generated on {currentResult.timestamp.toLocaleString()}
              </p>
            </div>
            <div className="flex space-x-2">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <Badge className={currentResult.trend === 'increasing' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}>
                    {currentResult.trend}
                  </Badge>
                </div>
                <div className="flex justify-between">
