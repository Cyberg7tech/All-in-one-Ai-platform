...
const agentTemplates: AgentTemplate[] = [
  {
    ...
    description:
      'Handle customer inquiries, support tickets, and provide helpful assistance with empathy and professionalism.',
    ...
    personality: {
      ...
      restrictions: [
        'Do not make promises about refunds without approval',
        'Always escalate complex technical issues',
      ],
    },
    useCase: 'Perfect for e-commerce, SaaS, and service businesses',
    prompt:
      'You are a helpful and empathetic customer service representative. Always be polite, professional, and solution-focused.',
  },
  {
    id: 'data-analyst',
    name: 'Data Analysis Expert',
    description:
      'Analyze complex datasets, generate insights, create forecasts, and detect anomalies in your business data.',
    type: 'data_analyst',
    icon: Brain,
    ...
    prompt:
      'You are an expert data analyst. Provide clear, accurate analysis with actionable insights and always explain your methodology.',
  },
  {
    id: 'content-creator',
    name: 'Content Creation Specialist',
    description:
      'Generate engaging content, social media posts, marketing copy, and creative materials that align with your brand.',
    ...
    prompt:
      'You are a creative content specialist. Create engaging, original content that resonates with the target audience while maintaining brand voice.',
  },
  {
    id: 'researcher',
    name: 'Research Assistant',
    description:
      'Conduct thorough research, fact-checking, competitive analysis, and provide comprehensive reports on any topic.',
    type: 'researcher',
    icon: Search,
    ...
    prompt:
      'You are a thorough research assistant. Provide well-researched, accurate information with proper citations and maintain objectivity.',
  },
  {
    id: 'developer',
    name: 'Developer Assistant',
    description:
      'Help with coding tasks, debugging, code reviews, architecture decisions, and technical documentation.',
    type: 'developer',
    icon: Code,
    ...
    prompt:
      'You are an experienced software developer. Provide clean, secure code with explanations and follow industry best practices.',
  },
];
...
const availableTools = [
  ...
  { id: 'vector_search', name: 'Knowledge Base', description: 'Search through uploaded documents' },
  {
    ...
    description: 'Generate predictions from time series data',
  },
        ...
        <Card>
          ...
          <CardContent className='space-y-4'>
            ...
            <div>
              ...
              <div className='p-3 bg-muted rounded-md text-sm'>{agentData.systemPrompt}</div>
            </div>
          </CardContent>
        </Card>
