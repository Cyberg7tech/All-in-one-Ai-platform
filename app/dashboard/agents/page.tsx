...
const demoAgents: Agent[] = [
  {
    ...
    systemPrompt: 'You are a creative marketing assistant. Help users create compelling marketing content, analyze trends, and develop strategies.',
  ...
  },
  {
    ...
    systemPrompt: 'You are an expert code reviewer. Analyze code for bugs, performance issues, security vulnerabilities, and suggest improvements.',
  ...
  },
  {
    ...
    systemPrompt: 'You are a data analyst. Help users understand their data through analysis, visualizations, and actionable insights.',
  ...
  },
  {
    ...
    systemPrompt: 'You are a research assistant. Help users find information, analyze sources, and create comprehensive reports.',
  ...
  },
  {
    ...
    systemPrompt: 'You are a creative writer. Help users craft compelling stories, articles, and creative content with engaging narratives.',
  ...
  },
  {
    ...
    status: 'active',
    tools: ['web_search', 'send_email'],
    systemPrompt: 'You are a helpful customer support agent. Assist customers with their questions, resolve issues, and provide excellent service.',
  ...
  },
  {
    ...
    systemPrompt: 'You are a social media expert. Create engaging posts, analyze trends, and help build social media presence.',
  ...
  },
  {
    ...
    systemPrompt: 'You are a math tutor. Help students understand mathematical concepts, solve problems, and provide clear explanations.',
  ...
  },
  {
    ...
    systemPrompt: 'You are a business consultant. Provide strategic advice, financial insights, and help with business planning.',
  ...
  },
  {
    ...
    status: 'active',
    tools: ['web_search'],
    systemPrompt: 'You are a language expert. Translate text accurately, explain grammar, and help with language learning.',
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className={`font-medium ${
                    ...
                    agent.successRate >= 80 ? 'text-yellow-600' : 'text-red-600'
                  }`}>
                    {agent.successRate}%
                  </span>
                </div>
