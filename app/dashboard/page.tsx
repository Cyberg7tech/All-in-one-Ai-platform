    ...
    if (user) {
      ...
      const createSampleActivities = async () => {
        try {
          ...
          await dbHelpers.addActivity(user.id, 'Registration', 'Account Created', 'Welcome to One AI platform!', '👤');
          ...
          setRecentActivity([
            { id: '1', type: 'Registration', name: 'Account Created', description: 'Welcome to One AI!', icon: '👤', timestamp: new Date().toISOString() },
            { id: '2', type: 'Login', name: 'Dashboard Access', description: 'Accessed the dashboard', icon: '🏠', timestamp: new Date().toISOString() }
          ]);
        }
      };
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${
                ...
                {user?.subscription_plan ? user.subscription_plan.charAt(0).toUpperCase() + user.subscription_plan.slice(1) + ' Plan' : 'User Plan'}
              </div>
