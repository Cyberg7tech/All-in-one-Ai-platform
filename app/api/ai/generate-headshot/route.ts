    ...
    try {
      ...
      try {
        ...
        headshotData = {
          ...
          negative_prompt: 'blurry, low quality, distorted features, unprofessional clothing, poor lighting, multiple people',
          photography_settings: {
            lighting: style === 'professional' ? 'Soft, even studio lighting with fill light' : 'Natural window light with reflector',
            camera_angle: 'Slightly above eye level for most flattering angle',
            focal_length: '85mm-135mm for natural perspective',
            depth_of_field: background === 'studio' ? 'Shallow DOF, blurred background' : 'Medium DOF, contextual background'
          },
          style_specifications: {
            clothing_suggestions: industry === 'corporate' ? ['Business suit', 'Dress shirt', 'Professional blazer'] :
                                 industry === 'creative' ? ['Smart casual', 'Artistic attire', 'Expressive styling'] :
                                 ['Professional attire', 'Clean styling', 'Industry-appropriate'],
            color_palette: style === 'warm' ? ['#F4E4BC', '#E8B366', '#D49C3D'] : 
                          style === 'cool' ? ['#B8D4F1', '#7FB3D3', '#4682B4'] :
                          ['#F5F5F5', '#D3D3D3', '#4A4A4A'],
            mood_descriptors: mood === 'confident' ? ['Assured', 'Professional', 'Approachable'] :
                             mood === 'friendly' ? ['Warm', 'Welcoming', 'Personable'] :
                             ['Professional', 'Competent', 'Trustworthy'],
            industry_appropriate: industry ? `Tailored for ${industry} industry standards and expectations` : 'Versatile professional appearance'
          },
          composition_guidelines: {
            ...
            expression_guidance: 'Genuine smile or confident neutral expression, eyes looking directly at camera',
