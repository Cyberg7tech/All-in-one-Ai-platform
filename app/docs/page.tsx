    ...
    <div className='min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900'>
      <div className='container mx-auto px-4 py-8'>
        ...
        <div className='mb-8'>
          ...
          <p className='text-gray-300 text-lg'>Complete guide to using the One Ai platform</p>
        </div>
          ...
          <Card className='bg-gray-800 border-gray-700'>
            ...
            <CardContent>
              <p className='text-gray-300'>
                Chat with multiple AI models including Llama, Qwen, and DeepSeek. Get intelligent responses
                for any task.
              </p>
            </CardContent>
          </Card>
          ...
          <CardContent>
            <div className='space-y-3'>
              ...
              <div>
                ...
                <p className='text-gray-300'>
                  All API communications are secured with HTTPS and proper authentication.
                </p>
              </div>
              <div>
