...
(function () {
  ...
  window.addEventListener(
    ...
    function (e) {
      if (
        e.error &&
        e.error.message &&
        e.error.message.includes("Cannot read properties of undefined (reading 'call')")
      ) {
  ...
  window.addEventListener('unhandledrejection', function (e) {
    if (
      e.reason &&
      e.reason.message &&
      e.reason.message.includes("Cannot read properties of undefined (reading 'call')")
    ) {
  ...
  window.addEventListener('unhandledrejection', function (event) {
    if (
      ...
      event.reason.message.includes("Cannot read properties of undefined (reading 'call')")
    ) {
